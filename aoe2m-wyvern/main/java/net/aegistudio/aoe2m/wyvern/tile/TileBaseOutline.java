...
public class TileBaseOutline implements TileOutline {
	private final double neX, neY, seX, seY, atX, atY;
	public TileBaseOutline(double neX, double neY, 
			double seX, double seY, double atX, double atY) {
	...
	public void any(Coordinator coord, Terrain terrain, double x, double y, double z) throws LWJGLException {
		map(coord, terrain, x, y, elevation(terrain, x, y) + z);
	}
